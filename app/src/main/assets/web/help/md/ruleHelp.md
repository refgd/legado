...
```
* jsLib
> 注入JavaScript到阅读规则引擎中，支持两种格式，可实现[函数共用](https://github.com/gedoor/legado/wiki/JavaScript%E5%87%BD%E6%95%B0%E5%85%B1%E7%94%A8)　
...
getVariable(): String?
Rust Analyzer URL host相关函数,js中通过java.调用
